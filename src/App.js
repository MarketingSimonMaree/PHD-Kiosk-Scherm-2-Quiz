...
function App() {
 ...
 const modalContent = {
  1: {
    ...
    primaryUrl: "javascript:window.kiosk.split('https://phd-digitale-adviseur-final-v4-s95f-q3paedswv.vercel.app/', 'https://plafondhogedeur.nl/collections/deurmodellen-phd-kiosk');",
  ...
  2: {
    ...
    primaryUrl: "javascript:window.kiosk.split('https://phd-digitale-adviseur-final-v4-s95f-q3paedswv.vercel.app/', 'https://plafondhogedeur.nl/collections/deurmodellen-phd-kiosk');",
    secondaryUrl: "javascript:window.kiosk.split('https://phd-digitale-adviseur-final-v4-s95f-q3paedswv.vercel.app/', 'https://plafondhogedeur.nl/pages/contact');",
